...
// Generates the first use case (4 waypoints) to move the at6x 
void waypoints_arm_goal(control_msgs::FollowJointTrajectoryGoal& goal)
{
  ...
  // Four waypoints in this goal trajectory
  ...
  goal.trajectory.points[index].positions[1] = 0.41;
  goal.trajectory.points[index].positions[2] = 3.65;
  goal.trajectory.points[index].positions[3] = 5.27;
  goal.trajectory.points[index].positions[4] = 4.34;
  ...
  // To be reached 15 second after starting along the trajectory
  ...
  index += 1;
  goal.trajectory.points[index].positions.resize(6);
  goal.trajectory.points[index].positions[0] = 5.67;
  goal.trajectory.points[index].positions[1] = 5.43;
  goal.trajectory.points[index].positions[2] = 4.9;
  goal.trajectory.points[index].positions[3] = 6.0;
  goal.trajectory.points[index].positions[4] = 5.55;
  goal.trajectory.points[index].positions[5] = 0.0;
  // Velocities
  goal.trajectory.points[index].velocities.resize(6);
  for (int j = 0; j < 6; ++j)
  ...
  // To be reached 4 seconds after starting along the trajectory
  goal.trajectory.points[index].time_from_start = ros::Duration(22.0);
  ...
  goal.trajectory.points[index].positions.resize(6);
  goal.trajectory.points[index].positions[0] = 0.0;
  goal.trajectory.points[index].positions[1] = 0.53;
  goal.trajectory.points[index].positions[2] = 4.13;
  goal.trajectory.points[index].positions[3] = 5.47;
  goal.trajectory.points[index].positions[4] = 4.09;
  goal.trajectory.points[index].positions[5] = 0.0;
  // Velocities
  goal.trajectory.points[index].velocities.resize(6);
  for (int j = 0; j < 6; ++j)
  ...
  // To be reached 4 seconds after starting along the trajectory
  goal.trajectory.points[index].time_from_start = ros::Duration(25.0);
}
